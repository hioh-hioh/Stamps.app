...
export default function TermsPage() {
  return (
    ...
    <div style={{padding:"0 16px 40px",fontSize:14,color:"#222",fontFamily:"inherit",animation:"slideInRight 0.25s ease-out"}}>
      ...
      <h1 style={{fontSize:20,fontWeight:700,marginTop:20,marginBottom:24}}>利用規約 / Terms of Use</h1>
      ...
      <div style={{lineHeight:1.85,color:"#333",display:"flex",flexDirection:"column",gap:28}}>
        <div>
          ...
          <p style={{color:"#888",marginTop:6}}>By using this service, you agree to these Terms of Use.</p>
        </div>
        ...
        <div>
          ...
          <p style={{color:"#888",marginTop:8}}>The following actions are prohibited:</p>
          <ul style={{paddingLeft:20,margin:"8px 0",color:"#888",display:"flex",flexDirection:"column",gap:4}}>
        ...
        <div>
          ...
          <p style={{color:"#888",marginTop:6}}>Users retain ownership of their posted content. However, we may use it to the extent necessary for operating the service.</p>
        </div>
        ...
        <div>
          ...
          <p style={{color:"#888",marginTop:6}}>We are not liable for any damages arising from the use of this service. The service may be modified or discontinued without notice.</p>
        </div>

        <div>
          <h2 style={{fontSize:15,fontWeight:700,marginBottom:8}}>5. 準拠法</h2>
          <p>本規約は日本法に準拠します。</p>
          <p style={{color:"#888",marginTop:6}}>These Terms of Use are governed by the laws of Japan.</p>
        </div>
      </div>
